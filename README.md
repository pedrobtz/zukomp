...
`system.file("lib", package = "zukomp")`, which a `configure` script can
resolve into `src/Makevars` without adding an `Imports:` dependency:
...
- **You get your own copy of miniz**, linked into your shared object, sharing
  ...
  match-distance check among them.
